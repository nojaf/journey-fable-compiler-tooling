...
module express =
    ...
    and IRouter<'T> =
        ...
        abstract get: name: string * handlers: RequestHandler -> unit
    ...
    and RequestHandler = Request -> Response -> unit
    ...
    and Application =
        ...
        abstract engine: ext: string * fn: ('FIn->'FOut) -> Application
        ...
        abstract configure: fn: ('FIn->'FOut) -> Application
        abstract configure: env0: string * fn: ('FIn->'FOut) -> Application
        abstract configure: env0: string * env1: string * fn: ('FIn->'FOut) -> Application
        abstract configure: env0: string * env1: string * env2: string * fn: ('FIn->'FOut) -> Application
        abstract configure: env0: string * env1: string * env2: string * env3: string * fn: ('FIn->'FOut) -> Application
        abstract configure: env0: string * env1: string * env2: string * env3: string * env4: string * fn: ('FIn->'FOut) -> Application
        ...
        abstract listen: port: int * hostname: string * backlog: float * ?callback: ('FIn->'FOut) -> Http.Server
        abstract listen: port: int * hostname: string * ?callback: ('FIn->'FOut) -> Http.Server
        abstract listen: port: int * ?callback: ('FIn->'FOut) -> Http.Server
        abstract listen: path: string * ?callback: ('FIn->'FOut) -> Http.Server
        abstract listen: handle: obj * ?listeningListener: ('FIn->'FOut) -> Http.Server
        abstract route: path: string -> IRoute
    ...
    module mime =
        ...
        type Globals =
            abstract charsets: Charsets with get, set
            abstract default_type: string with get, set
            abstract lookup: path: string -> string
            abstract extension: mime: string -> string
            abstract load: filepath: string -> unit
            abstract define: mimes: obj -> unit
    ...
    module ``serve-static`` =
        ...
        type Globals =
            abstract mime: mime.Globals
            [<Emit("$0($1...)")>] abstract Invoke: root: string * ?options: Options -> Handler

    type Globals =
        abstract ``static``: ``serve-static``.Globals
        abstract Router: ?options: obj -> Router
        [<Emit("$0($1...)")>] abstract Invoke: unit -> Express
